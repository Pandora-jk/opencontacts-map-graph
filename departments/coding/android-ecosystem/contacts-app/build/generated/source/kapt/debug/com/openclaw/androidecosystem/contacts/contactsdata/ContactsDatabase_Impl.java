  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `contacts` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `displayName` TEXT NOT NULL, `phone` TEXT, `email` TEXT, `photoUri` TEXT, `lastContacted` INTEGER, `connectionStrength` INTEGER NOT NULL)");
        ...
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '43fb74d9b94d7a7b2bfc2c09c3bf1cc2')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        _columnsContacts.put("lastContacted", new TableInfo.Column("lastContacted", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsContacts.put("connectionStrength", new TableInfo.Column("connectionStrength", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _indicesContacts.add(new TableInfo.Index("index_contacts_displayName", false, Arrays.asList("displayName"), Arrays.asList("ASC")));
        _indicesContacts.add(new TableInfo.Index("index_contacts_phone", false, Arrays.asList("phone"), Arrays.asList("ASC")));
        ...
        if (!_infoContacts.equals(_existingContacts)) {
          return new RoomOpenHelper.ValidationResult(false, "contacts(com.openclaw.androidecosystem.contacts.contactsdata.ContactEntity).\n"
                  + " Expected:\n" + _infoContacts + "\n"
                  + " Found:\n" + _existingContacts);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "43fb74d9b94d7a7b2bfc2c09c3bf1cc2", "2177f02931d337f409018149bb103c35");
