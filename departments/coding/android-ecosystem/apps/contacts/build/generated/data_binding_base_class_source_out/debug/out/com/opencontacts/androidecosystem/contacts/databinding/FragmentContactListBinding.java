...
public final class FragmentContactListBinding implements ViewBinding {
  ...
  private FragmentContactListBinding(@NonNull FrameLayout rootView, @NonNull TextView emptyText,
      @NonNull ProgressBar loadingSpinner, @NonNull RecyclerView recyclerView) {
  ...
  public static FragmentContactListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentContactListBinding((FrameLayout) rootView, emptyText, loadingSpinner,
          recyclerView);
    }
