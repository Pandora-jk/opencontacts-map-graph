...
- **Timestamp (UTC):** 20260310T075632Z
- **Run ID:** 20260310
...
```
Root usage: /: 99% used (19G/19G, avail 223M)
...
- Need about 3.4G reclaimed to reach <=80% on /
  All allowlisted home caches total 2.5G across 4 path(s); short by 919M
...
- RISK: Root usage: /: 99% used (19G/19G, avail 223M)
CRITICAL: Root filesystem usage is 99% (>90%)
Inodes: /: 15% used
Top disk usage under / (depth 1):
18G	/
