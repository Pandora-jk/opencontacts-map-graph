...
- UTC: 2026-03-11T06:00:01.549869Z

## Disk Usage
Root usage: /: 97% used (18G/18G, avail 655M)
...
- Need about 1.2G reclaimed to reach <=90% on /
  All workspace logs total 5.3M across 2 path(s); short by 1.2G
...
- Need about 1.2G reclaimed to reach <=90% on /
  All workspace caches total 236K across 1 path(s); short by 1.2G
...
- Need about 1.2G reclaimed to reach <=90% on /
  All allowlisted home caches total 300M across 2 path(s); short by 907M
...
- Need about 1.2G reclaimed to reach <=90% on /
  All host-level caches/logs total 776M across 2 path(s); short by 430M
...
- Need about 3.0G reclaimed to reach <=80% on /
  All host-level caches/logs total 776M across 2 path(s); short by 2.3G
  - /var/cache/apt: sudo apt-get clean
  - /var/log/journal: sudo journalctl --vacuum-time=7d
  Additional reclaim is still required after host-level cleanup
...
- 0B sh pid=62184 35188 /tmp/#35188 (deleted)
- 0B sh pid=62184 35188 /tmp/#35188 (deleted)
