...
- **Timestamp (UTC):** 20260310T143248Z
- **Run ID:** 20260310
...
```
ALERT: Unexpected externally exposed listeners (4): tcp/17480, tcp/36193, tcp/40159, udp/51546
```
...
- RISK: Root usage: /: 100% used (18G/18G, avail 177M)
CRITICAL: Root filesystem usage is 100% (>90%)
Inodes: /: 15% used
Top disk usage under / (depth 1):
18G	/
...
Protected-root hint: reclaim caches first; remove these only when intentionally uninstalling the owning toolchain
No deleted-but-open files detected
- RISK: ALERT: Unexpected externally exposed listeners (4): tcp/17480, tcp/36193, tcp/40159, udp/51546
