...
- UTC: 2026-03-09T18:45:29.599271Z
...
- Need about 1.7G reclaimed to reach <=90% on /
  ...
  Review top stale /tmp paths: python3 tools/infra_tmp_cleanup.py --limit 5
  Current scan found 140 writable stale /tmp path(s); rerun the helper with a higher --limit or targeted --path values before cleanup
