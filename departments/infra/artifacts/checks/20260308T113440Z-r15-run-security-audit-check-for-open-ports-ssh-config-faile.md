...
- UTC: 2026-03-08T11:34:40.665688Z
...
HARDENING: stage/test the install outside /etc with `python3 tools/infra_mdns_hardening.py --install-to /tmp/resolved.conf.d/99-openclaw-no-mdns.conf --validate-live --live-dropin-path /tmp/resolved.conf.d/99-openclaw-no-mdns.conf --resolved-dropins-dir /tmp/resolved.conf.d`
