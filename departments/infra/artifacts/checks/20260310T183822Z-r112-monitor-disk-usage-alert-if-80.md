...
- UTC: 2026-03-10T18:38:22.797809Z

## Disk Usage
Root usage: /: 100% used (18G/18G, avail 117M)
...
- 5.5M /home/ubuntu/.openclaw/workspace/logs/night-infra.log (generated workspace log)
...
- 120K /home/ubuntu/.openclaw/workspace/tests/__pycache__ (Python bytecode cache)
...
120K	/home/ubuntu/.openclaw/workspace/tests/__pycache__
...
- Need about 1.7G reclaimed to reach <=90% on /
  All workspace logs total 7.2M across 2 path(s); short by 1.7G
...
- Need about 3.5G reclaimed to reach <=80% on /
  All workspace logs total 7.2M across 2 path(s); short by 3.5G
  Review remaining workspace logs: python3 tools/infra_workspace_log_cleanup.py --path /home/ubuntu/.openclaw/workspace/logs/night-infra.log --path /home/ubuntu/.openclaw/workspace/logs/night-coding.log
  Host-level reclaim is still required after workspace-log cleanup
Current-session writable workspace-cache plan:
- Need about 1.7G reclaimed to reach <=90% on /
  All workspace caches total 340K across 2 path(s); short by 1.7G
...
- Need about 3.5G reclaimed to reach <=80% on /
  All workspace caches total 340K across 2 path(s); short by 3.5G
  Review remaining workspace caches: python3 tools/infra_workspace_cache_cleanup.py --path /home/ubuntu/.openclaw/workspace/tools/__pycache__ --path /home/ubuntu/.openclaw/workspace/tests/__pycache__
  Host-level reclaim is still required after workspace-cache cleanup
...
- Need about 3.5G reclaimed to reach <=80% on /
  All allowlisted home caches total 2.6G across 4 path(s); short by 971M
...
- Need about 1.7G reclaimed to reach <=90% on /
  All host-level caches/logs total 776M across 2 path(s); short by 968M
