...
- UTC: 2026-03-12T07:59:46.816594Z
...
## Auth Source Summary
ALERT: Auth event sources in sampled logs (9 events / 3 source(s)): 94.26.106.200 x4 (users: squid, user3); 116.110.156.53 x3 (users: installer, squid); 171.231.198.250 x2 (users: admin)
